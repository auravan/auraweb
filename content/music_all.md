...
---
[spiralchrod最新进展](/spiralchorddemov2/v121.html)
...
**点击图像上的节点(除了排练，我真的很少做这件事)可以查看更多关于我的信息。**
...
理论级别的分析是编曲，除了歌曲整体的结构（总谱），他还会教你怎么正确理解和使用效果器来达到目标效果，这就像shader之于计算机视觉。[这里](https://www.hooktheory.com/chordProgressionNode)有大量流行歌的markov实例。所有你感兴趣的和弦进行应该都有。

now with ai,目前的级别是token级别，每1ms都被分析成为一种可能的语句。

如果是演奏家，那么你更关注指法如何排列才能更好地演奏曲谱。最近机器人弹钢琴好像挺流行，应该会有突破。
## 音乐的初始意志

首先当然是好听，然后是自由，想去哪就去哪。音乐之树从人类深处扎根，由生命得以滋养。每一片叶子(某种markov链)都是一处风景。

音乐最后的注意力应该在哪里，当然应该是作者本身的生平和成就以及不朽的作品，还有音乐交织起来的故事。
