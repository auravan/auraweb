(function (exports, Laya) {
        ...
        set source(value) {
            ...
            if (value) {
                ...
                if (Laya.SerializeUtil.isDeserializing)
                    ...
                    Laya.ILaya.timer.runCallLater(this, this.changeSource, true);
    ...
    class UIComponent extends Laya.Sprite {
        ...
        _transChanged(kind) {
            ...
            if ((kind & Laya.TransformKind.Layout) != 0)
        ...
        onMouseOver(e) {
            Laya.ILaya.stage.event(exports.UIEvent.SHOW_TIP, this._toolTip);
        }
        onMouseOut(e) {
            Laya.ILaya.stage.event(exports.UIEvent.HIDE_TIP, this._toolTip);
        }
        get_top() {
    ...
    class Button extends UIComponent {
        ...
        _setSkin(url) {
            ...
            if (url) {
                ...
                if (!tex) {
                    const sk = this._skin;
                    return Laya.ILaya.loader.load(url, Laya.Loader.IMAGE).then(tex => {
        ...
        changePanel() {
            ...
            for (var i = 0; i < 12; i++) {
                for (var j = 0; j < 20; j++) {
                    ...
                    var strColor = Laya.Color.hexToString(color);
    ...
    class Label extends UIComponent {
        ...
        set fitContent(value) {
            ...
            if (this._fitContent != value) {
                if ((value == "yes" || value == "height")
                    ...
                    && (!this._getBit(Laya.NodeFlags.EDITING_NODE) || this._tf.textWidth > 0 && this._tf.textHeight > 0)) {
                    if (value == "height")
        ...
        size(width, height) {
            if (this._fitContent == "yes" && !this._fitFlag
                && (!this._getBit(Laya.NodeFlags.EDITING_NODE) || this._tf.textWidth > 0))
                width = this._width;
            if ((this._fitContent == "yes" || this._fitContent == "height") && !this._fitFlag
                && (!this._getBit(Laya.NodeFlags.EDITING_NODE) || this._tf.textHeight > 0))
                height = this._height;
    ...
    class Image extends UIComponent {
        ...
        _setSkin(url) {
            ...
            if (url) {
                if (this._skinBaseUrl)
                    url = Laya.URL.formatURL(url, this._skinBaseUrl);
                let source = Laya.Loader.getRes(url, Laya.Loader.IMAGE);
                if (source) {
                    this.source = source;
                    return Promise.resolve();
                }
    ...
    class ScrollBar extends UIComponent {
        ...
        onStageMouseUp2(e) {
            ...
            if (this._isElastic) {
                if (this._value < this.min) {
                    ...
                    Laya.Tween.to(this, { value: moveValue }, this.elasticBackTime, ScrollBar.easeFunction, Laya.Handler.create(this, this.elasticOver));
                }
                else if (this._value > this.max) {
        ...
        tweenMove(maxDistance) {
            ...
            if (Math.abs(this._lastOffset) < 0.1) {
                ...
                if (this._isElastic) {
                    if (this._value < this.min) {
                        Laya.Tween.to(this, { value: this.min }, this.elasticBackTime, ScrollBar.easeFunction, Laya.Handler.create(this, this.elasticOver));
                    }
                    else if (this._value > this.max) {
                        Laya.Tween.to(this, { value: this.max }, this.elasticBackTime, ScrollBar.easeFunction, Laya.Handler.create(this, this.elasticOver));
                    }
                    else {
                        this.elasticOver();
                    }
        ...
        _backToNormal(value) {
            Laya.Tween.to(this, { value: value }, this.elasticBackTime, ScrollBar.easeFunction, Laya.Handler.create(this, this.elasticOver));
        }
    }
    ScrollBar.easeFunction = Laya.Ease.sineOut;
    ...
    class List extends Box {
        ...
        set scrollBar(value) {
            if (this._scrollBar != value) {
                ...
                if (value) {
                    ...
                    this._content.scrollRect = new Laya.Rectangle();
                }
            }
        }
        get itemRender() {
        ...
        createItem() {
            ...
            if (typeof (this._itemRender) == "function") {
            ...
            else if (this._itemRender instanceof Laya.Prefab) {
                box = this._itemRender.create();
            }
            else {
                if (this._itemRender._$type || this._itemRender._$prefab)
                    ...
                    box = Laya.PrefabImpl.legacySceneOrPrefab.createComp(this._itemRender, null, null, arr);
            }
            if (!box) {
        ...
        changeCellState(cell, visible, index) {
            let selectBox = cell.getChild("selectBox");
            if (selectBox) {
    ...
    class ComboBox extends UIComponent {
        ...
        changeList() {
            ...
            let _padding = (this.itemPadding) ? this.itemPadding : "3,3,3,`10`";
    ...
    class Dialog extends View {
        ...
        _dealDragArea() {
            var dragTarget = this.getChild("drag");
            if (dragTarget) {
    ...
    class Panel extends Box {
        ...
        _panelChildChanged(child) {
            if (child) {
                if (child.parent)
                    child.on(Laya.Event.RESIZE, this, this._setScrollChanged);
                else
                    child.off(Laya.Event.RESIZE, this, this._setScrollChanged);
    ...
    class PanelContentBox extends Box {
        _childChanged(child) {
            super._childChanged(child);
            this._parent && this._parent._panelChildChanged(child);
        }
    }
    ...
    class TipManager extends UIComponent {
        ...
        constructor() {
            ...
            Laya.ILaya.stage.on(exports.UIEvent.SHOW_TIP, this, this._onStageShowTip);
            Laya.ILaya.stage.on(exports.UIEvent.HIDE_TIP, this, this._onStageHideTip);
            this.zOrder = 1100;
        }
        _onStageHideTip(e) {
        ...
        _showToStage(dis, offX = 0, offY = 0) {
            let rec = dis.getBounds(Laya.Rectangle.TEMP);
    ...
    class Tree extends Box {
        ...
        renderItem(cell, index) {
            ...
            if (item) {
                ...
                let folder = cell.getChild("folder");
                if (folder) {
                    if (folder.clipY == 2) {
